...
CFLAGS = -fno-pic -static -fno-builtin -fno-strict-aliasing -O0 -Wall -MD -ggdb -march=i386 -m32 -Werror -Wno-infinite-recursion -fno-omit-frame-pointer
...
UPROGS=$(patsubst %,user/%,$(shell $(MAKE) -s -C user print-uprogs))
...
# https://www.mail-archive.com/qemu-discuss@nongnu.org/msg07249.html
